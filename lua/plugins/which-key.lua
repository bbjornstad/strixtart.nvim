...
return {
  {
    ...
    opts = {
      ...
      win = {
        ...
        width = { min = 26, max = 80 },
        -- height = { min = 4, max = 25 },
        col = vim.api.nvim_win_get_width(0) - 8,
        -- row = math.huge,
      ...
      layout = {
        width = { min = 16 }, -- min and max width of the columns
        height = { max = 0.6 },
    ...
    keys = {
      {
        ...
        "<CMD>WhichKey '' i<CR>",
        mode = { "n", "i" },
        desc = "help:keys| insert |=> mappings",
      },
      {
        "<C-g>n",
        "<CMD>WhichKey '' n<CR>",
        mode = { "n" },
        desc = "help:keys| normal |=> mappings",
      },
      {
        "<C-g>v",
        "<CMD>WhichKey '' v<CR>",
        mode = "v",
        desc = "help:keys| visual |=> mappings",
      },
    },
  ...
  },
  {
    ...
    keys = {
      {
        key_view.key_analyzer,
        "<CMD>KeyAnalyzer<CR>",
        mode = "n",
        desc = "map:keys| anal |=> open",
      },
    },
  },
}

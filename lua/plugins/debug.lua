local key_debug = require("keys.debug")
...
return {
    ...
    dependencies = {
      "mfussenegger/nvim-dap",
      {
        ...
        opts = function(_, opts)
          ...
          opts.library = table.insert(opts.library, "nvim-dap-ui")
        end,
      },
  ...
  },
  {
    ...
    keys = {
      {
        key_shortcut.diagnostics.breakpoint.next,
        function()
      ...
      {
        key_shortcut.diagnostics.breakpoint.previous,
        function()
      ...
      {
        key_shortcut.diagnostics.breakpoint.stopped,
        function()

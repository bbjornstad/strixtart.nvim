local key_repl = require("keys.repl")
...
return {
    ...
    keys = {
      {
        ...
        mode = "n",
        desc = "repl:| iron |=> open ftype repl",
      },
      {
  ...
  },
  {
    ...
    init = function()
      ...
      vim.g.molten_output_win_border = uienv.borders.main
  ...
  },
  {
    ...
    opts = function(_, opts)
      ...
      opts.metas = vim.tbl_deep_extend("force", {
        aichat = {
          cmd = "aichat",
